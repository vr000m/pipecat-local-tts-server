...
# The seven shipped backends (see the justfile _resolve map + README port table).
_BACKEND_RE = re.compile(r"^(tone|kokoro|voxtral_tts|pocket_tts|dia|qwen3_tts|fish_tts)$")
